...
driver_sleeping = driver.find_element_by_xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/form[1]/div[6]/div[2]/div[2]/div[1]/label[4]").click()
time.sleep(.5)
