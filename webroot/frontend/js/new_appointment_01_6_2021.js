...
$(document).on("click", "input[type='radio'].cancer_family_history", function () {
...
$(document).on("click", "input[type='radio'].cancer_medical_question_370", function () {
...
$(document).on("click", "input[type='radio'].cancer_medical_question_355", function () {
...
// Show PMH Question
$(document).on("click", "input[type='radio'].cancer_medical_question_528", function () {
