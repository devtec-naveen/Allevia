$( document ).ready(function() {
    ...
    $( "#ort-tab" ).click(function() { $( '#ort-tabpostlink' ).trigger('click'); });
    $( "#m3-tab" ).click(function() { $( '#m3-tabpostlink' ).trigger('click'); });
    ...
    // Internal medication Module tab
    $( "#general-assessment-tab" ).click(function() { $( '#general-assessment-tabpostlink' ).trigger('click'); });
    $( "#taps1-assessment-tab" ).click(function() { $( '#taps1-assessment-tabpostlink' ).trigger('click'); });
    $( "#taps2-assessment-tab" ).click(function() { $( '#taps2-assessment-tabpostlink' ).trigger('click'); });
    $( "#advdir-assessment-tab" ).click(function() { $( '#advdir-assessment-tabpostlink' ).trigger('click'); });
    // End
    ...
    $( "#internal_assessment-tab" ).click(function() { $( '#internal_assessment-tabpostlink' ).trigger('click'); });
    // end
    $( "#psychiatry_follow_up-tab" ).click(function() { $( '#psychiatry_follow_up-tabpostlink' ).trigger('click'); });
     ...
     $( "#annual-phq9-tab-backbtn" ).click(function() { $( '#phq_9-tabpostlink' ).trigger('click'); });
   ...
   // $("#focus_history-backbtn").click(function() { alert('dfd');$('#focus_history-tabpostlink').trigger('click'); });
    ...
    // Internal medicine
    $( "#internal_medicine_info-backbtn" ).click(function() { $( '#contact-tabpostlink' ).trigger('click'); });
    $( "#internal_medicine_assessment-backbtn" ).click(function() { $( '#cancer_medical_history-tab' ).trigger('click'); });
    $( "#internal_medicine_cc-backbtn" ).click(function() {$( '#home-tabpostlink' ).trigger('click'); });
    $( "#internal_mh_assessments-backbtn" ).click(function() { $( '#chronic_assessment-tabpostlink' ).trigger('click'); });
    $( "#internal_medicine_detail-backbtn" ).click(function() { $( '#profile-tabpostlink' ).trigger('click'); });
    // $( "#internal_assessment-backbtn" ).click(function() { $( '#cancer_medical_history-tabpostlink' ).trigger('click'); });
    $( "#cc_detail-backbtn" ).click(function() { $( '#profile-tabpostlink' ).trigger('click'); });
    $( "#chief_cc-backbtn" ).click(function() {$( '#home-tabpostlink' ).trigger('click'); });
    $( "#pre_assessment-backbtn" ).click(function() { $( '#mad_refill_drug-tabpostlink' ).trigger('click'); });
    $( "#folloup_general-backbtn" ).click(function() { $( '#psychiatry_follow_up-tabpostlink' ).trigger('click'); });
...
$(".go_to_part_2").click(function(){
    ...
    $("#profile-tab222").click(function(event){
        ...
        $('#home222 .row').each(function( index, element ) {
            $(element).find('input[type=checkbox]').each(function( inindex, inelement ) {
                if(!cntflg) cntflg =  $(inelement).is(":checked");
            });
            //alert(cntflg)
            if(!cntflg) field_empty = false;
            cntflg = false;
        });
        //alert(field_empty)
        if(field_empty){
...
let loading = async(msg ='') => {
        homeLoader = $('.dashboard_content').loadingIndicator({
                    useImage: false,
...
$("#form_tab_34_general").validate({
        ...
        showErrors: function(errorMap, errorList) {
            ...
            if(errorList.length>0)
            {
                $("#internal_assessment div.errorHolder").addClass(' alert alert-danger').html("*All fields must be completed before you submit the form.");
            }
        },
        submitHandler: function(form) {
            formsubmit(form);
    ...
    $("#form_tab_34").validate({
        showErrors: function(errorMap, errorList) {
            if(errorList.length>0)
            {
                $("#form_tab_34 div.errorHolder").addClass(' alert alert-danger').html("*All fields must be completed before you submit the form.");
            }
        },
        submitHandler: function(form) {
            formsubmit(form);
...
$(document).on("click", "input[type='radio'].chronic_general_question_700", function () {

    if($(this).is(':checked')) {

        if ($(this).val() == 'Yes') {

            $('.chronic_general_question_700_701').removeClass('display_none_at_load_time').show();
        }
        else{


            $('.chronic_general_question_701').val('');
            $('.chronic_general_question_700_701').hide();
        }
    }
});
...
$(document).on("click", "input[type='radio'].chronic_general_question_702", function () {
    if($(this).is(':checked')) {

        if ($(this).val() == 'Yes') {

            $('.chronic_general_question_702_703').removeClass('display_none_at_load_time').show();
        }
        else{

            $('.chronic_general_question_703').val('');
            $('.chronic_general_question_702_703').hide();
        }
    }
});
...
$('body').on('focus',".chronic_general_question_318, .chronic_general_question_703", function(){
    var date = new Date();
    $(this).datepicker({
        maxDate: date
    });
    ...
    //  console.log( $("#isClicked").val());
      ...
      if ($(this).val() == 'No') {
           ...
           if(que_id == 362){
            ...
            $(".cancer_medical_question_693").each(function( index, element ) {
                        $(this).prop("checked", false);
                });
        }
});
...
// Internal medication jquery
$(document).ready(function () {

    var flag = false;

    $( "input[type='radio'].is_chief_complaint_doctor_558" ).each(function( index, element ) {
...
$(document).ready(function () {
    ...
    $( "input[type='radio'].is_chief_complaint_doctor_559" ).each(function( index, element ) {
...
$(document).ready(function () {
    ...
    $( "input[type='checkbox'].chronic_condition_dmii" ).each(function( index, element ) {
...
$(document).on("click", "input[type='checkbox'].chronic_condition_none", function () {
    if($(this).is(':checked')) {
        $(".chronic_conditions_questions").each(function( index, element ) {
                    // if($(element).is(':checked') && $(element).val() == 'none'){
...
$(document).on("click", "input[type='checkbox'].chronic_conditions_questions", function () {
    if($(this).is(':checked')) {
                       $('.chronic_condition_none').prop("checked", false);

        }

    });
$(document).on("click", "input[type='radio'].cancer_medical_question_564", function () {
    if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.smoking_medical_question_564_565').hide();
                $(".cancer_medical_question_565").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.smoking_medical_question_564_565').removeClass('display_none_at_load_time').show();
...
$(document).on("click", "input[type='radio'].cancer_medical_question_566", function () {
    if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.smoking_medical_question_566_567').hide();
                $(".cancer_medical_question_567").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.smoking_medical_question_566_567').removeClass('display_none_at_load_time').show();

             }
         }

    });
$(document).on("click", "input[type='checkbox'].cancer_medical_question_563", function () {
    var val = $(this).attr('data-name');
                if($(this).is(':checked')) {
                        if(val == "None")
                        {
                            $(".drinking_items_563").each(function( index, element ) {

                            $(this).prop("checked", false);
                            $('.drink_medical_detail_563').hide();
                            $('.how_many_drinking_items_563').val('');
                        });

                        }
                        $('.cancer_medical_detail_563_'+val).removeClass('display_none_at_load_time').show();
                }else{

                        $('.cancer_medical_detail_563_'+val).hide();
                        $('.how_many_time_drink_563_'+val).val('');

                    }
    });

$(document).on("click", "input[type='checkbox'].drinking_items_563", function () {
    if($(this).is(':checked')) {
                       $('.drinking_items_none_of_these').prop("checked", false);

        }

    });
$(document).on("click", "input[type='radio'].cancer_medical_question_563", function () {
    var val = $(this).attr('data-name');
    alert(val)
                if($(this).is(':checked')) {
                        if(val == "None")
...
$(document).on("click", "input[type='radio'].internal_taps2_question_576", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_576_577_578').hide();
                $(".internal_taps2_question_577, .internal_taps2_question_578").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.internal_medication_taps2_question_576_577_578').removeClass('display_none_at_load_time').show();
...
$(document).on("click", "input[type='radio'].internal_taps2_question_579", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_579_580_581_582_583').hide();
                $(".internal_taps2_question_580, .internal_taps2_question_581, .internal_taps2_question_582, .internal_taps2_question_583").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.internal_medication_taps2_question_579_580_581_582_583').removeClass('display_none_at_load_time').show();
...
$(document).on("click", "input[type='radio'].internal_taps2_question_584", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_584_585_586').hide();
                $(".internal_taps2_question_585, .internal_taps2_question_586").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.internal_medication_taps2_question_584_585_586').removeClass('display_none_at_load_time').show();
...
$(document).on("click", "input[type='radio'].internal_taps2_question_587", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_587_588_589').hide();
                $(".internal_taps2_question_588, .internal_taps2_question_589").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.internal_medication_taps2_question_587_588_589').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].internal_taps2_question_590", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_590_591_592').hide();
                $(".internal_taps2_question_591, .internal_taps2_question_592").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.internal_medication_taps2_question_590_591_592').removeClass('display_none_at_load_time').show();
...
$(document).on("click", "input[type='radio'].internal_taps2_question_593", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_593_594_595').hide();
                $(".internal_taps2_question_594, .internal_taps2_question_595").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.internal_medication_taps2_question_593_594_595').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].internal_taps2_question_596", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_596_597_598').hide();
                $(".internal_taps2_question_597, .internal_taps2_question_598").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.internal_medication_taps2_question_596_597_598').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].internal_taps2_question_599", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_599_600_601').hide();
                $(".internal_taps2_question_600, .internal_taps2_question_601").each(function( index, element ) {
                    $(this).prop("checked", false);
            });
        }else{

            $('.internal_medication_taps2_question_599_600_601').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].internal_taps2_question_602", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.internal_medication_taps2_question_602_603').hide();
                $(".internal_taps2_question_603").val('');
        }else{

            $('.internal_medication_taps2_question_602_603').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].internal_med_general_question_607", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'Younger') {
                $('.int_gen_med_607_570').removeClass('display_none_at_load_time').show();
                $('.int_gen_med_607_569').hide();
                $('#question_569').val('');
        }else if($(this).val() == "Older")
        {

           $('.int_gen_med_607_569').removeClass('display_none_at_load_time').show();
           $('.int_gen_med_607_570').hide();
           $('#question_570').val('');
        }
        else if($(this).val() == "About my age")
        {
           $('.int_gen_med_607_570, .int_gen_med_607_569').hide();
           $('#question_570, #question_569').val('');
        }
         }
...
$(document).ready(function () {
    ...
    $( "input[type='radio'].internal_med_general_question_607" ).each(function( index, element ) {
        if($(element).is(':checked')){
    ...
    if(flag){
        if($(this).val() == "Younger")
        {
           $('.int_gen_med_607_570').removeClass('display_none_at_load_time').show();
           $('.int_gen_med_607_569').hide();
           $('.int_gen_med_607_569').val('');

       }else if($(this).val() == "Older")
        {
           $('.int_gen_med_607_569').removeClass('display_none_at_load_time').show();
           $('.int_gen_med_607_570').hide();
           $('.int_gen_med_607_570').val('');
        }
        ...
        $('.int_gen_med_607_570').hide();
        $('.int_gen_med_607_569').hide();
        $('.internal_med_general_question_607').prop('checked', false);
    }

});

$(document).on("click", "input[type='checkbox'].chief_complaint_psychiatry_612", function () {

    var flag = false;
    $( "input[type='checkbox'].chief_complaint_psychiatry_612" ).each(function( index, element ) {
    ...
    if(flag){
        ...
        $('.chief_complaint_psychiatry_612_613').removeClass('display_none_at_load_time').show();
        // $('.chief_complaint_psychiatry_613').val('');
    }
    else{

        $('.chief_complaint_psychiatry_612_613').hide();
        $('.chief_complaint_psychiatry_613').val('');
    }
});
...
$(document).on("click", "input[type='checkbox'].chief_complaint_psychiatry_614", function () {

    var flag = false;
    $( "input[type='checkbox'].chief_complaint_psychiatry_614" ).each(function( index, element ) {
    ...
    if(flag){
        ...
        $('.chief_complaint_psychiatry_614_615').removeClass('display_none_at_load_time').show();
        // $('.chief_complaint_psychiatry_613').val('');
    }
    else{

        $('.chief_complaint_psychiatry_614_615').hide();
        $('.chief_complaint_psychiatry_615').val('');
    }
});
...
$(document).on("click", "input[type='checkbox'].chief_complaint_psychiatry_612", function () {
    ...
    if($(this).is(':checked')) {
        ...
        if ($(this).val() == 'None') {
            ...
            var id = $(this).attr('id');
            $(".chief_complaint_psychiatry_612").prop("checked", false);
            $(".chief_complaint_psychiatry_612#"+id).prop("checked", true);
            $('.chief_complaint_psychiatry_612_613').hide();
            $('.chief_complaint_psychiatry_613').val('');
            ...
            $('.chief_complaint_psychiatry_612').each(function(index, value){
...
$(document).on("click", "input[type='radio'].cancer_medical_question_623", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.cancer_medical_question_623_624').hide();
                $(".cancer_medical_question_624").val('');
        }else{

            $('.cancer_medical_question_623_624').removeClass('display_none_at_load_time').show();
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_620", function () {
    var flag = false;
    $( "input[type='checkbox'].cancer_medical_question_620" ).each(function( index, element ) {
    ...
    if(flag){
        ...
        $('.cancer_medical_question_620_679').removeClass('display_none_at_load_time').show();
    }
    else{

        $('.cancer_medical_question_620_679').hide();
        $('.cancer_medical_question_679').val('');
    }
});
$(document).ready(function () {
    ...
    if(flag){
        ...
        $('.cancer_medical_question_620_679').hide();
        $('.chief_complaint_psychiatry_679').val('');
    }
});
$(document).on("click", "input[type='checkbox'].cancer_medical_question_621", function () {
    var flag = false;
    $( "input[type='checkbox'].cancer_medical_question_621" ).each(function( index, element ) {
    ...
    if(flag){
        ...
        $('.cancer_medical_question_621_680').removeClass('display_none_at_load_time').show();
    }
    else{

        $('.cancer_medical_question_621_680').hide();
        $('.cancer_medical_question_680').val('');
    }
});
$(document).ready(function () {
    ...
    if(flag){
        ...
        $('.cancer_medical_question_621_680').hide();
        $('.chief_complaint_psychiatry_680').val('');
    }
});


// $(document).on("click", "input[type='checkbox'].cancer_medical_question_630", function () {
//     $( "input[type='checkbox'].cancer_medical_question_630" ).each(function( index, element ) {

//         if($(element).is(':checked') && $(element).val() == 'Physical'){

//              $('.cancer_medical_question_630_631').removeClass('display_none_at_load_time').show();
//         }
//         else{
//         $('.cancer_medical_question_630_631').hide();
//         $(".cancer_medical_question_631").each(function( index, element ) {
//                     $(this).prop("checked", false);
//             });
//         }
//         if($(element).is(':checked') && $(element).val() == 'Sexual'){

//              $('.cancer_medical_question_630_632').removeClass('display_none_at_load_time').show();
//         }
//         else{
//         $('.cancer_medical_question_630_632').hide();
//         $(".cancer_medical_question_632").each(function( index, element ) {
//                     $(this).prop("checked", false);
//             });
//         }
//       });
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_628", function () {
    var flag = false;
    $( "input[type='checkbox'].cancer_medical_question_628" ).each(function( index, element ) {

        //alert($(element).val());

        if($(element).is(':checked') && $(element).val() == 'DWI'){
    ...
    if(flag){
        ...
        $('.cancer_medical_question_628_629').removeClass('display_none_at_load_time').show();
    }
    else{

        $('.cancer_medical_question_628_629').hide();
        $('.cancer_medical_question_629').val('');
    }
});
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_628", function () {
    if($(this).is(':checked')) {
        if ($(this).val() == 'None') {
            ...
            var id = $(this).attr('id');
            $(".cancer_medical_question_628").prop("checked", false);
            $(".cancer_medical_question_628#"+id).prop("checked", true);
            $('.cancer_medical_question_628_629').hide();
            $('.cancer_medical_question_629').val('');

        }else{
            $('.cancer_medical_question_628').each(function(index, value){
...
$(document).ready(function () {
    ...
    if(flag){
        ...
        $('.cancer_medical_question_628_629').hide();
        $('.chief_complaint_psychiatry_629').val('');
    }
});

$(document).on("click", "input[type='checkbox'].cancer_medical_question_633", function () {
    var flag = false;
    $( "input[type='checkbox'].cancer_medical_question_633" ).each(function( index, element ) {

        //alert($(element).val());

        if($(element).val() == 'Active duty'){
            if($(element).is(':checked'))
            {
            ...
            if(flag){
                ...
                $('.cancer_medical_question_633_634').removeClass('display_none_at_load_time').show();
            }
            else{

                $('.cancer_medical_question_633_634, .cancer_medical_question_634_635, .cancer_medical_question_635_636').hide();
                $(".cancer_medical_question_634, .cancer_medical_question_635, .cancer_medical_question_636").each(function( index, element ) {
                            $(this).prop("checked", false);
                    });
            }
        }
    ...
    $( "input[type='checkbox'].cancer_medical_question_633" ).each(function( index, element ) {
        ...
        if($(element).val() == 'Veteran'){
            ...
            if(flag){
                ...
                $('.cancer_medical_question_633_637').removeClass('display_none_at_load_time').show();
            }
            else{

                $('.cancer_medical_question_633_637, .cancer_medical_question_637_638').hide();
                $(".cancer_medical_question_637, .cancer_medical_question_638").each(function( index, element ) {
                            $(this).prop("checked", false);
                    });
            }
        }
...
$(document).on("click", "input[type='radio'].cancer_medical_question_616", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.cancer_medical_question_616_617').hide();
                $(".cancer_medical_question_617").val('');
        }else{

            $('.cancer_medical_question_616_617').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].cancer_medical_question_634", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.cancer_medical_question_634_635, .cancer_medical_question_635_636').hide();
                $(".cancer_medical_question_635, .cancer_medical_question_636").each(function( index, element ) {
                            $(this).prop("checked", false);
                    });
        }else{

            $('.cancer_medical_question_634_635').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].cancer_medical_question_635", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.cancer_medical_question_635_636').hide();
                $(".cancer_medical_question_636").each(function( index, element ) {
                            $(this).prop("checked", false);
                    });
        }else{

            $('.cancer_medical_question_635_636').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].cancer_medical_question_637", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.cancer_medical_question_637_638, .cancer_medical_question_638_695, .cancer_medical_question_695_639').hide();
                $(".cancer_medical_question_638, .cancer_medical_question_695").each(function( index, element ) {
                            $(this).prop("checked", false);
                    });
                $(".cancer_medical_question_639").val('');
        }else{

            $('.cancer_medical_question_637_638').removeClass('display_none_at_load_time').show();
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_633", function () {
    ...
    if($(this).is(':checked')) {
        //alert($(this).val());
        if ($(this).val() == 'None (Civillian)') {

            var id = $(this).attr('id');
            $(".cancer_medical_question_633").prop("checked", false);
            $(".cancer_medical_question_633#"+id).prop("checked", true);

            $('.cancer_medical_question_633_634, .cancer_medical_question_634_635, .cancer_medical_question_635_636, .cancer_medical_question_633_637, .cancer_medical_question_637_638, .cancer_medical_question_638_695, .cancer_medical_question_695_639').hide();
            $(".cancer_medical_question_634, .cancer_medical_question_635, .cancer_medical_question_636, .cancer_medical_question_637, .cancer_medical_question_638, .cancer_medical_question_695").each(function( index, element ) {
                        $(this).prop("checked", false);
                });
            $("..cancer_medical_question_639").val('');
            ...
            $('.cancer_medical_question_633').each(function(index, value){
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_683", function () {
    var flag = false;
    $( "input[type='checkbox'].cancer_medical_question_683" ).each(function( index, element ) {
    ...
    if(flag){
        ...
        $('.cancer_medical_question_683_684').removeClass('display_none_at_load_time').show();
    }
    else{

        $('.cancer_medical_question_683_684').hide();
        $('.cancer_medical_question_684').val('');
    }
});
$(document).ready(function () {
    ...
    if(flag){
        ...
        $('.cancer_medical_question_683_684').hide();
        $('.chief_complaint_psychiatry_684').val('');
    }
});
$(document).on("click", "input[type='checkbox'].cancer_medical_question_683", function () {
    if($(this).is(':checked')) {
        if ($(this).val() == 'None of these') {
            ...
            var id = $(this).attr('id');
            $(".cancer_medical_question_683").prop("checked", false);
            $(".cancer_medical_question_683#"+id).prop("checked", true);
            $('.cancer_medical_question_683_684').hide();
            $('.cancer_medical_question_684').val('');

        }else{

            $('.cancer_medical_question_683').each(function(index, value){
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_620", function () {
    if($(this).is(':checked')) {
        if ($(this).val() == 'None') {
            ...
            var id = $(this).attr('id');
            $(".cancer_medical_question_620").prop("checked", false);
            $(".cancer_medical_question_620#"+id).prop("checked", true);
            $('.cancer_medical_question_620_679').hide();
            $('.cancer_medical_question_679').val('');
            ...
            $('.cancer_medical_question_620').each(function(index, value){
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_621", function () {
    if($(this).is(':checked')) {
        if ($(this).val() == 'None') {
            ...
            var id = $(this).attr('id');
            $(".cancer_medical_question_621").prop("checked", false);
            $(".cancer_medical_question_621#"+id).prop("checked", true);
            $('.cancer_medical_question_621_680').hide();
            $('.cancer_medical_question_680').val('');

        }else{
            $('.cancer_medical_question_621').each(function(index, value){
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_691", function () {
    var flag = false;
    $( "input[type='checkbox'].cancer_medical_question_691" ).each(function( index, element ) {
        if($(element).is(':checked') && $(element).val() == 'Yes'){
    ...
    if(flag){
        ...
        $('.cancer_medical_question_691_692').removeClass('display_none_at_load_time').show();
    }
    else{

        $('.cancer_medical_question_691_692').hide();
        $('.cancer_medical_question_692').val('');
    }
});
$(document).ready(function () {
...
$(document).on("click", "input[type='checkbox'].chief_complaint_psychiatry_694", function () {
    var flag = false;
    $( "input[type='checkbox'].chief_complaint_psychiatry_694" ).each(function( index, element ) {

        if($(element).val() == 'Changing Providers'){
            ...
            if(flag){
                ...
                $('.chief_complaint_psychiatry_694_611').removeClass('display_none_at_load_time').show();
            }
            else{

                $('.chief_complaint_psychiatry_694_611').hide();
                $('.chief_complaint_psychiatry_611').val('');
            }
        }
      });
...
$(document).on("click", "input[type='checkbox'].chief_complaint_psychiatry_694", function () {
    ...
    $( "input[type='checkbox'].chief_complaint_psychiatry_694" ).each(function( index, element ) {
        ...
        //alert($(element).val());
        if($(element).val() == 'Medication refill'){
            ...
            if(flag){
                ...
                $('.currentMedicationSection').removeClass('display_none_at_load_time').show();
                $('.chief_complaint_psychiatry_694_610').removeClass('display_none_at_load_time').show();
            }
            else{

                $(".currentMedicationSection").load(location.href + " .currentMedicationSection");
                $('.currentMedicationSection, .chief_complaint_psychiatry_694_610').hide();
                $('.chief_complaint_psychiatry_610').val('');
            }
        }
      });
    ...
    $( "input[type='checkbox'].chief_complaint_psychiatry_694" ).each(function( index, element ) {
        if($(element).val() == 'Medication refill'){
            ...
            if(flag){
                ...
                $(".currentMedicationSection").load(location.href + " .currentMedicationSection");
                $('.currentMedicationSection, .chief_complaint_psychiatry_694_610').hide();
                // $('.chief_complaint_psychiatry_694_610').hide();
                $('.chief_complaint_psychiatry_610').val('');
            }
        }
      });
...
$(document).on("click", "input[type='checkbox'].chief_complaint_psychiatry_694", function () {
    ...
    $( "input[type='checkbox'].chief_complaint_psychiatry_694" ).each(function( index, element ) {
        ...
        //alert($(element).val());
        if($(element).val() == 'Symptom Complaints'){
            ...
            if(flag){
                ...
                $('.chief_complaint_section').removeClass('display_none_at_load_time').show();
            }
            else{

                $(".chief_complaint_section").load(location.href + " .chief_complaint_section");
                $('.chief_complaint_section').hide();
            }
        }
      });
...
$(document).on("click", "input[type='radio'].cancer_medical_question_638", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'No') {
                $('.cancer_medical_question_638_695, .cancer_medical_question_695_639').hide();
                $(".cancer_medical_question_695").each(function( index, element ) {
                            $(this).prop("checked", false);
                    });
                $(".cancer_medical_question_639").val('');
            ...
            $('.cancer_medical_question_638_695').removeClass('display_none_at_load_time').show();

             }
         }

});
$(document).on("click", "input[type='radio'].cancer_medical_question_695", function () {
        if($(this).is(':checked')) {
            if ($(this).val() == 'Yes') {
                $('.cancer_medical_question_695_639').hide();
                $(".cancer_medical_question_639").val('');
        }else{

            $('.cancer_medical_question_695_639').removeClass('display_none_at_load_time').show();
...
$(document).on("click", "input[type='checkbox'].cancer_medical_question_693", function () {
    if($(this).is(':checked')) {
        if ($(this).val() == 'Yes') {
            $(".cancer_medical_question_685, .cancer_medical_question_686, .cancer_medical_question_687, .cancer_medical_question_688, .cancer_medical_question_689, .cancer_medical_question_690, .cancer_medical_question_691").prop("checked", false);
            $(".cancer_family_members_685, .cancer_family_members_686, .cancer_family_members_687, .cancer_family_members_688, .cancer_family_members_689, .cancer_family_members_690, .cancer_family_members_691").each(function( index, element ) {
                        $(this).prop("checked", false);
                });
            $(".cancer_family_members_que_685, .cancer_family_members_que_686, .cancer_family_members_que_687, .cancer_family_members_que_688, .cancer_family_members_que_689, .cancer_family_members_que_690, .cancer_family_members_que_691, .cancer_medical_question_691_692").hide();
            $(".cancer_medical_question_692").val('');

        }else{

            // $('.cancer_medical_question_693').each(function(index, value){
            //
            //     if($(this).val() == 'No'){
            //
            //         $(this).prop("checked", false);
...
$(document).on("click", "input[type='checkbox'].is_chief_complaint_doctor_704", function () {

    var flag = false;
    $( "input[type='checkbox'].is_chief_complaint_doctor_704" ).each(function( index, element ) {
    ...
    if(flag){
        ...
        $('.is_chief_complaint_doctor_704_705').removeClass('display_none_at_load_time').show();
        // $('.chief_complaint_psychiatry_613').val('');
    }
    else{

        $('.is_chief_complaint_doctor_704_705').hide();
        $('.is_chief_complaint_doctor_705').val('');
    }
});
...
$(document).on("click", "input[type='checkbox'].is_chief_complaint_doctor_708", function () {

    var flag = false;
    $( "input[type='checkbox'].is_chief_complaint_doctor_708" ).each(function( index, element ) {
    ...
    if(flag){
        ...
        $('.is_chief_complaint_doctor_708_709').removeClass('display_none_at_load_time').show();
    }
    else{

        $('.is_chief_complaint_doctor_708_709').hide();
        $('.is_chief_complaint_doctor_709').val('');
    }
});
$(document).ready(function () {
...
$(document).on("click", "input[type='radio'].is_chief_complaint_doctor_560", function () {

    var flag = false;
    $( "input[type='radio'].is_chief_complaint_doctor_560" ).each(function( index, element ) {
    ...
    if(flag){
        ...
        $('.is_chief_complaint_doctor_560_706_707_708').removeClass('display_none_at_load_time').show();
    }
    else{

        $('.is_chief_complaint_doctor_560_706_707_708, .is_chief_complaint_doctor_708_709').hide();
        $('.is_chief_complaint_doctor_706, .is_chief_complaint_doctor_707, .is_chief_complaint_doctor_709').val('');
        $(".is_chief_complaint_doctor_708").each(function( index, element ) {
                            $(this).prop("checked", false);
                    });
    }
});
