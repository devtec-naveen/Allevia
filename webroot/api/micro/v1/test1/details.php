...
if ($testing) {
	$existingJson["caseId"] = "5007A000005VXoiQAG";#"5001h0000052q6RAAQ";
	$existingJson["caseNumber"] = "00003930";#"00001098";
}
...
if ($testing) {
	...
	// GET /supported POST /details POST /note
	curl_setopt($ch, CURLOPT_URL, "https://q3clezf4jb.execute-api.us-east-2.amazonaws.com/alpha/details");	
}
