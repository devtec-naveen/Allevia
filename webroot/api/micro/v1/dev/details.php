...
// To allow cookies to persist in iframes.
$currentCookieParams = session_get_cookie_params();  
$sidvalue = session_id(); 
...
$testing = "2"; // "0" for prod, "1" for sbuat, "2" for partial
...
if ($testing == "1") {
	...
	$existingJson["caseId"] = "5001h000005NU5vAAG";
	$existingJson["caseNumber"] = "00001961";
}
