	 ...
	 <div class="form_fild_content row">
	  <div class="col-md-6">
	   <div class="form-group form_fild_row"> 
	      <?php echo  $this->Form->control('otp', ['type' => 'text', 'class' => 'form-control', 'placeholder' => 'Otp', 'label' => '', 'autocomplete' => 'off', 'required' => 'required']); ?>	    
	   </div>
...
<input type="hidden" class="hiddenRecaptcha required" name="hiddenRecaptcha" id="hiddenRecaptcha"> -->
     <!-- </div> -->
	  ...
	  <div class="col-md-6 ger_box">
	   <div class="form_ger">
	    <img src="<?= WEBROOT ?>images/security-otp.jpg"/>
	   </div>
	  </div>
	 </div>
