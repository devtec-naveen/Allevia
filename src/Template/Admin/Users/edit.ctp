                                ...
                                <div class="form-group form-float">
                                 ...
                                 <div class="form-group form-float">
                                  ...
                                  <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                     <?php echo $this->Form->input("phone" , array("type" => "text","class" => "form-control",'data-msg-required'=>'Enter Phone Number *','label' => false, 'title'=>'Enter Phone Number', "disabled" => true));?>
