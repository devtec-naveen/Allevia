                        ...
                        <div class="header">
                            <h2>
                             ...
                             <ol class="breadcrumb breadcrumb-col-blue header-dropdown m-r--5">
                                ...
                                <li class="active">Edit Value Props</li>
                            </ol>
                        </div>
                        <div class="body">
                          ...
                          <div class="form-group form-float">
                             <label class="form-label">Value Props Image</label>                                    
                                 ...
                                 <img width="100px" height="100px" src="<?php echo WEBROOT.'img/'.$organizations->image; ?>">
                                     ...
                                     <?php echo $this->Form->input("image" , array("type" => "file","class" => "form-control",'data-msg-required'=>'Value Props Image','label' => false, 'title'=>'Value Props Image', "required" => false));?>
