...
<!--                                 <li><a href="<?= ADMIN_SITE_URL.'cms'  ?>">CMS</a></li> -->
                        ...
                        <div class="body">
                                 <?php echo $this->Form->create($homepagedata, array('id'=>'edit_cms','enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group form-float">
                                  ...
                                  <div class="form-group form-float">
                                    ...
                                    <label class="form-label">Home page sectoin 1 Image</label>

                                    <div class="form-line">
                                  <img width="100px" height="100px" src="<?php echo WEBROOT.'img/'.$homepagedata->homepage_sec1_img1; ?>">                                      
                                     <?php echo $this->Form->input("homepage_sec1_img1" , array("type" => "file","class" => "form-control",'data-msg-required'=>'Enter ','label' => false, 'title'=>'Enter Page Title', "required" => false));?>
                        ...
                        <label class="form-label">Enter Section 1 Image 2</label>                                    
                                  ...
                                  <div class="form-group form-float">
                                    <div class="form-line">
                                     <?php echo $this->Form->input("homepage_sec1_subtitle2" , array("type" => "text","class" => "form-control",'data-msg-required'=>'Enter Sectoin 1 Subtitle 2','label' => false, 'title'=>'Enter Sectoin 1 Subtitle 2', "required" => true));?>
                                     <label class="form-label">Enter Sectoin 1 Subtitle 2</label>
                                  </div>
                                  </div>
                                  <div class="form-group form-float">
                ...
                <label class="form-label">Enter Section 2 Image</label>                                    
                      ...
                      <label class="form-label">Enter Section 3 Image</label>                                    
                                 ...
                                 <img width="100px" height="100px" src="<?php echo WEBROOT.'img/'.$homepagedata->homepage_sec3_image; ?>">
                                  ...
                                  <div class="form-group form-float">
                                    <div class="form-line">
                                     <?php echo $this->Form->input("homepage_valueprops_title" , array("type" => "text","class" => "form-control",'data-msg-required'=>'Enter Home page value props section title','label' => false, 'title'=>'Enter Home page value props section title', "required" => true));?>
                                     <label class="form-label">Enter Home page value props section title</label>
                                  </div>
                                  </div>
