...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//	}
		...
		if($testmode) {
			...
			// $this->paypal_endpoint = 'https://api-3t.sandbox.paypal.com/nvp';
			// $this->paypal_username = 'tmyroniak-facilitator@icloud.com';
			// $this->paypal_password = 'ASEQLnpRlvnMgal14X6LcAwrKD9w2I_mzN2joxYp-wWV_ALO5irG7sDH5xWJgOW90loeOoLdnX4um042';
			// $this->paypal_signature = 'ECwmBDYVud-ZwX1b55qug1HlOkEbNs4IjTTYtYnpHEyYAIGZh5iElCCZFTM6tTJDPHHAB87Ks-QHa51g';

	$this->paypal_endpoint = 'https://api-3t.sandbox.paypal.com/nvp';
			$this->paypal_username = 'myroniakt@hotmail.com';
			$this->paypal_password = 'Kw@tzo2018!';
			$this->paypal_signature = 'ECwmBDYVud-ZwX1b55qug1HlOkEbNs4IjTTYtYnpHEyYAIGZh5iElCCZFTM6tTJDPHHAB87Ks-QHa51g';
		...
		else
		{
			...
			$this->paypal_endpoint = 'https://api-3t.paypal.com/nvp';
			$this->paypal_username = 'tmyroniak@icloud.com';
			$this->paypal_password = 'ASM7uw_Rh1Yn5iM9tIHLscFb6qG1YHwqukp_lZdWiHa9znORWpdt2Vzkt16rzrrlcdV9beIVc0g99qQc';
			$this->paypal_signature = 'EEin5wGEWe--2jmlTlulceHWA2knp9KyGjzkTDO1NeCO7Xg9M5fxgIuwTZOzfFNmttlx9CYEb1cCmWW0';
		...
		$response = $httpSocket->post($this->paypal_endpoint, http_build_query($doDirectPaymentNvp), ['type' => 'xml']);
		//pr($response->body);
		//die;
