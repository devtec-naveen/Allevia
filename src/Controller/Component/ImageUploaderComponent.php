...
//namespace App\Controller\Component;
//use App\Controller\Component\Component;
...
class ImageUploaderComponent extends Component { 
  ...
  * )
  * */
 //public $components = array('FileUploader'=>array('extensions'=>array('jpeg','JPEG','gif','GIF','bmp','jpg','JPG','png','PNG'),'sizeLimit'=>5242880));
  ...
  */
  ...
  public function upload($formData, $path=null,$options=array('custom_name'=>null, 'thumbnail'=>null, 'max_width'=>null)){
    ...
    * */
	 ...
	 */
	 $thumbnails = (!empty($options['thumbnail']))? $options['thumbnail'] : FALSE;
	 ...
	 */
     ...
     if($thumbnails !== FALSE){
         foreach($thumbnails as $thumbnail ){
            $thumbnail_filename = (!empty($thumbnail['custom_name']))? $thumbnail['custom_name'] : $fullFilename;    			  
      ...
      */
      ...
      return array("file_name"=>$fullFilename,'bool'=>TRUE,'file_path'=>$current_filePath,'file_path_max_width'=>$new_filePath,'thumb_path'=>$thumbnail_path);
